...
class EventoAsistenciaScreen extends StatefulWidget {
  const EventoAsistenciaScreen({super.key});

  @override
  State<EventoAsistenciaScreen> createState() => _EventoAsistenciaScreenState();
}

class _EventoAsistenciaScreenState extends State<EventoAsistenciaScreen> {
  ...
  Future<void> _saveCertificateImage(setStateDialog) async {
    ...
    try {
      ...
      final String imageName =
          'asistencia_${DateTime.now().millisecondsSinceEpoch}';
  ...
  void _onSubmit() {
    if (_formKey.currentState!.validate()) {
      ...
      _ctrl.eventoAsistenciaPost({
        "eve_id": evento.eveId,
        "per_ci": int.parse(_ciController.text),
        "eve_codigo": _codigoController.text,
